...
@Repository
public class AuthorDao extends DAOImpl<AuthorRecord, entity.demo.tables.pojos.Author, Integer> {

    /**
     * Create a new AuthorDao without any configuration
     */
    public AuthorDao() {
        super(Author.AUTHOR, entity.demo.tables.pojos.Author.class);
    }
    ...
    public AuthorDao(Configuration configuration) {
        super(Author.AUTHOR, entity.demo.tables.pojos.Author.class, configuration);
    }

    @Override
    public Integer getId(entity.demo.tables.pojos.Author object) {
        return object.getId();
    }
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchById(Integer... values) {
     ...
     */
    public entity.demo.tables.pojos.Author fetchOneById(Integer value) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchRangeOfFirstName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchByFirstName(String... values) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchRangeOfLastName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchByLastName(String... values) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchRangeOfDateOfBirth(LocalDate lowerInclusive, LocalDate upperInclusive) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchByDateOfBirth(LocalDate... values) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchRangeOfYearOfBirth(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchByYearOfBirth(Integer... values) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchRangeOfDistinguished(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<entity.demo.tables.pojos.Author> fetchByDistinguished(Byte... values) {
     ...
     */
    public entity.demo.tables.pojos.Author fetchRecord(Integer Id) {
        return this.ctx().selectFrom(Author.AUTHOR).where(Author.AUTHOR.ID.eq(Id)).fetchOneInto(entity.demo.tables.pojos.Author.class);
    }

    /**
     * Created custom Insert records Method
     */
    public entity.demo.tables.pojos.Author insertRecord(entity.demo.tables.pojos.Author classObject) {
        ...
        record.store();
        entity.demo.tables.pojos.Author result = record.into(entity.demo.tables.pojos.Author.class);
        return result;
    }
     ...
     */
    public int updateRecord(entity.demo.tables.pojos.Author classObject) {
